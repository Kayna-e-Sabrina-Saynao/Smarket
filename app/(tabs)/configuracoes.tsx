...
export default function ConfiguracoesScreen() {
  ...
  const lidarComNovaLista = () => {
    if (!canCreateList(currentPlan, currentListCount, isUltimate)) {
      abrirModalPremium("Este recurso está disponível apenas no plano correspondente.");
      return;
    }
  ...
  const lidarComCompartilhamento = () => {
    ...
    Alert.alert(
      ...
      "Seu plano Família libera recursos compartilhados. Agora só falta conectar o fluxo real de convite."
    );
  };
